...
public class Cours  implements Serializable{
	...
	public Cours(String intituleCours, Long prix, String duree) {
		super();
	...
	public Cours(String intituleCours, Long prix, String duree, String compteRendu, Matiere matiere,
			Collection<Disponibilite> date) {
		super();
		this.intituleCours = intituleCours;
		this.prix = prix;
		this.duree = duree;
