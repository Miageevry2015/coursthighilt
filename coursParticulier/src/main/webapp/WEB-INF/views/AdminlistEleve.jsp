...
<h1>AdminlistEleve</h1>
<table border=1>
<tr><th> Nom</th><th> prenom</th><th> date de naissance</th><th> e-mail</th><th> telephone</th><th> supp / mod</th></tr>
...
<td>${e.email}</td>
<td>${e.telephone}</td>
<td><input type="button" value="supprime" onclick="self.location.href='http://localhost:8080/test/admin/sup?id=${e.getIdUtilisateur()}'"/></td>
</tr>
</c:forEach>
</table>
</body>
